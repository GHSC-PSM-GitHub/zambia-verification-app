...
//		let s=this.analyseURI(gs1DigitalLinkURI,false);
		console.log("extractFromGS1digitalLink");
...
console.log("extractFromGS1digitalLink 1");
		...
		console.log("extractFromGS1digitalLink 2");
		...
		console.log("extractFromGS1digitalLink. 4");
...
export const interpretScan = (scan) => {
...
// console.log("Msg1===");
  ...
  if (gs1DigitalLinkURI == undefined) {
    ...
    returnObject['licensingMO'] = getLicensingMO(primaryKey, gs1Array.GS1[primaryKey]);
...
function isPlausibleGs1DlUri(s) {
  ...
  let op ={};
  op.uncompressedWithAlphas = RE1.test(s);  // true ifF string plausibly is an uncomprssed DL URI. Allows primary key to be defined using a convenience alpha (e.g. 'gtin')
